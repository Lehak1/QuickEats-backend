...
exports.validateMyUserRequest = [
    ...
    (0, express_validator_1.body)("addressLine1").isString().notEmpty().withMessage("Address must be sting"),
    (0, express_validator_1.body)("city").isString().notEmpty().withMessage("city must be a string"),
    (0, express_validator_1.body)("country").isString().notEmpty().withMessage("city must be a string"),
